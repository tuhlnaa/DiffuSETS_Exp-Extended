...
if __name__ == "__main__":
    ...
    if use_condition: 
        ...
        net = ECGnocondition(num_train_steps, kernel_size=7, num_levels=5, n_channels=n_channels)

    unet_path = './checkpoints/kdd_all_2/unet_best.pth'
